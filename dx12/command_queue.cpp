 ...
 */
bool CommandQueue::create(CommandType type) noexcept {
    // コマンドキュー作成
    D3D12_COMMAND_QUEUE_DESC queueDesc = {};

    queueDesc.Flags = D3D12_COMMAND_QUEUE_FLAG_NONE;
    queueDesc.Type  = type == CommandType::Compute ? D3D12_COMMAND_LIST_TYPE_COMPUTE : D3D12_COMMAND_LIST_TYPE_DIRECT;
